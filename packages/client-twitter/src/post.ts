...
Your response should not contain any questions. Brief, concise statements only. The total character count MUST be less than {{maxTweetLength}}. NEVER use hashtags, NEVER use emojis. Use \\n\\n (double spaces) between statements if there are multiple statements in your response.`;
...
export class TwitterPostClient {
    ...
    public async generateNewTweet(
        ...
        try {
            ...
            elizaLogger.log(
                "============== CONTEXT B ============= generateNewTweet. context = :\n" +
                    context
            );
    ...
    private async generateTweetContent(
        ...
        elizaLogger.log(
            "============== CONTEXT A ============= generateTweetContent. options.context = :\n" +
                options?.context
        );
        elizaLogger.log(
            "============== CONTEXT A ============= generateTweetContent. context = :\n" +
                context
        );
        ...
        try {
            ...
            for (const tweet of timelines) {
                try {
                    ...
                    elizaLogger.log(
                        "============== CONTEXT C ============= processTweetActions. actionContext = :\n" +
                            actionContext
                    );
